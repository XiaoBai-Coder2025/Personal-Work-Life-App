...
export async function renderSettings(root) {
  ...
  const settings = { amapWebKey: '', amapJsKey: '', aiBaseUrl: '', aiModel: '', aiKey: '', ...settingsData };
  ...
  root.append(
    ...
    h('section', { class: 'panel' },
      h('h2', {}, '接口 Key'),
      field('高德 Web 服务 Key（路线、周边、地理编码）', keyInput(settings.amapWebKey, (v) => { settings.amapWebKey = v; })),
      field('高德 JS Key（地图显示）', keyInput(settings.amapJsKey, (v) => { settings.amapJsKey = v; })),
